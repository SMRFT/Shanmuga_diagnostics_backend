...
def get_corporate_sample(request, batch_number):
    ...
    if request.method == "GET":
        ...
        try:
            ...
            # Collections
            samples_collection = db["corporatehealthcheckup_samplestatus"]
            patient_collection = db["corporatehealthcheckup_patient"]
            billing_collection = db["corporatehealthcheckup_billing"]
...
def update_corporate_sample(request, barcode):
    ...
    client = MongoClient(os.getenv('GLOBAL_DB_HOST'))
    db = client.Corporatehealthcheckup  # Database name
    collection = db.corporatehealthcheckup_samplestatus  # Collection name
...
def get_corporate_batch_generation_data(request):
    ...
    if request.method == "GET":
        ...
        try:
            ...
            client = MongoClient(os.getenv('GLOBAL_DB_HOST'))
            db = client.Corporatehealthcheckup  # Database name
            collection = db.corporatehealthcheckup_batch  # Collection name
...
def corporate_patient_test_details(request):
    ...
    try:
        ...
        franchise_billing_collection = db.corporatehealthcheckup_billing
        franchise_sample_collection = db.corporatehealthcheckup_samplestatus
        franchise_patient_collection = db.corporatehealthcheckup_patient
