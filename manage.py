...
def main():
    ...
    if environment == 'prod':
        os.environ.setdefault('DJANGO_SETTINGS_MODULE', 'shanmuga_backend.settings-prod')
    elif environment == 'test':
        os.environ.setdefault('DJANGO_SETTINGS_MODULE', 'shanmuga_backend.settings-test')
    else:
